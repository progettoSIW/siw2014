...
public class StudentRepository {
	...
	public void modificaStudente(Student student, String nome, String cognome) throws SQLException {
		Connection connection = this.dataSource.getConnection();
		PreparedStatement statement = null;
		try {
			if (findByPrimaryKey(student.getCode()) == null) {
			...
			String insert = "update students(code, firstname, lastname, birthDate) values (?,?,?,?)";
